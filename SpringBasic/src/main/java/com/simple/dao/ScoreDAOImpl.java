...
public class ScoreDAOImpl implements ScoreDAO {
	...
	public void scoreRegist(ScoreVO vo) {
		//insert, update, delete는 jddbc템플릿update(sql문, 바인딩값)이 대신합니다.
	...
	public ArrayList<ScoreVO> getList() {
		...
		List<ScoreVO> list = jdbcTemplate.query(sql, new Object[] {}, new RowMapper<ScoreVO>() {
			...
			public ScoreVO mapRow(ResultSet rs, int rowNum) throws SQLException {
				// 제네릭에는 select 구문을 처리해줄 vo객체를 적어줍니다.
				//mapRow메서드에는 select구문의 처리결과를 넣어주는데, 개발자는 resultSet을 어떻게 처리할지 구문만 작성하면 됩니다.
